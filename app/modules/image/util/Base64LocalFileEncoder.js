...
var Base64LocalFileEncoder = function (fileSystem) {
    this.file_path = '';
    this.fileSystem = fileSystem;
};
Base64LocalFileEncoder.prototype = Object.create(FileSaver);
...
Base64LocalFileEncoder.prototype.tryToReadFile = function(url, fileSystem, base64Promise) {
    return fileSystem.readFile(url).then(base64Promise).catch(reportError);
};

Base64LocalFileEncoder.prototype.base64Promise = function (data) {
    return new Promise(function (resolve, reject) {
        try {
...
Base64LocalFileEncoder.prototype.encodeFile = function (url) {
    this.file_path = url;
    return this.getFile();
};
